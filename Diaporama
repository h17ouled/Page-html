...
<button type="button" class="btn btn-default">Deep web</button>
...
<button type="button" class="btn btn-default">Captcha</button>
...
<button type="button" class="btn btn-default">MVC</button>
</body>
</html>
